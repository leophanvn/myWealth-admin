				...
				message={
					<div className="container d-block d-md-flex text-center text-md-left justify-content-between align-items-center">
						<div className="mr-0 mr-md-2 fs-sm mb-2 mb-md-0 flex-1">
							We use cookies to make interactions with our websites and services easy and meaningful, to better understand how they are used and to tailor advertising. You can read more and make your cookie choices <Link href="/cookie-policy" passHref><a>here</a></Link>. By continuing to use this site you are giving us your consent to do this.
						</div>
